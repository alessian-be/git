# **THIS IS NOT THE FORGEJO SOURCE CODE**

This is just a fork I made to experiment with building a project like this from source, and to store my "configs" for forgejo easier. You are free to use the code here in the same way as forgejo's, but please refer to the [**ORIGINAL REPO**](https://codeberg.org/forgejo/forgejo) if you somehow stumbled onto this thinking this is the official forgejo.
